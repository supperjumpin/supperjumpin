...
type SeasonRepository interface {
	...
	// FinalizeSeasonStunts calculates and persists final scores for all performed stunts in the season.
	FinalizeSeasonStunts(ctx context.Context, seasonID string) error
...
func FinalizeSeason(ctx context.Context, repo SeasonRepository, input FinalizeSeasonInput) FinalizeSeasonResult {
	...
	if season.Status != "Finalized" {
		...
		if err := repo.FinalizeSeasonStunts(ctx, season.ID); err != nil {
			return FinalizeSeasonResult{Err: err}
		}
